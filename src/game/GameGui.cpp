...
void GameGui::Render()
{
	...
	ImGui::Text("Rotation");
	ImGui::DragFloat("x##Rotation", &_game->Rotation().x, 0.05f, 0, 100);
	ImGui::DragFloat("y##Rotation", &_game->Rotation().y, 0.05f, 0, 100);
	ImGui::DragFloat("z##Rotation", &_game->Rotation().z, 0.05f, 0, 100);
